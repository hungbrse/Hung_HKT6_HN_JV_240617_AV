...
export default function GroundMember() {
  return (
    <>
      <GroundHeader />
        ...
        <div className="bg-white rounded-md  w-1/2 ">
          ...
          <div className="m-5 border-b-2 pb-4">
            <p className="text-[14px]">
              thành viên <span className="text-gray-400">2.201</span>
            </p>
          ...
          <div className="flex  mx-5 pb-4 border-b-2 justify-between">
            ...
            <div>
              <ul>
                <li className="flex border-b-2 justify-between  pb-4">
                  ...
                  <Button className="border-none bg-gray-300">
                    + thêm bạn bè
                  </Button>
                </li>
              </ul>
